            ...
            <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
              <ul>
                <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                  data-thumb='images/slide-img1.jpg'><img src='images/slide-img1.jpg' data-bgfit='cover'
                        ...
                        <div>
                          <div class="info">
                            <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-endspeed='500'
                              ...
                              style='z-index:2; white-space:nowrap;'><span>XE Nổi Bật 2021</span> </div>
                            <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-endspeed='500' data-speed='500'
                              ...
                              <span style="font-weight:normal; display:block"><br></span> Hiện Đại - Tinh Tế
                            </div>
                            ...
                            <div class='tp-caption sfb  tp-resizeme ' data-endspeed='500' data-speed='500'
                              ...
                              data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:4; white-space:nowrap;'>
                              <a href='#' class="buy-btn">Thuê Ngay</a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                  data-thumb='images/slide-img2.jpg'><img src='images/slide-img2.jpg' data-bgfit='cover'
                    data-bgrepeat='no-repeat' alt="banner" />
                  <div class="container">
                    <div class="content_slideshow">
                      <div class="row">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <a href="#" data-scroll-goto="1"> <img
              src="images/speakers.png" alt="promotion-banner1"> </a> </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <a href="#" data-scroll-goto="2"> <img
              src="images/schedule.png" alt="promotion-banner2"> </a> </div>
      </div>
    </div>
  </div>
  <!-- Slide ưu đãi-->
        ...
        <div class="slider-items slider-width-col4 products-grid">
            ...
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="images/tn1.jpg" alt="Retis lapen casen"></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="images/tn2.jpg" alt="Retis lapen casen"></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="images/tn3.jpg" alt="Retis lapen casen"></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="images/tn4.jpg" alt="Retis lapen casen"></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="images/tn5.jpg" alt="Retis lapen casen"></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="images/tn6.jpg" alt="Retis lapen casen"></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="slider-items slider-width-col4 products-grid">
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="products-images/p1.jpg" alt="Retis lapen casen"></a>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="products-images/p2.jpg" alt="Retis lapen casen"></a>
                  <div class="item-box-hover">
                    <div class="box-inner">
                      <div class="add_cart">
                        <button class="button btn-cart" type="button"></button>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"> <a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="products-images/p3.jpg" alt="Retis lapen casen"></a>
                  <div class="item-box-hover">
                    <div class="box-inner">
                      <div class="add_cart">
                        <button class="button btn-cart" type="button"></button>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="products-images/p12.jpg" alt="Retis lapen casen"></a>
                  <div class="item-box-hover">
                    <div class="box-inner">
                      <div class="add_cart">
                        <button class="button btn-cart" type="button"></button>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="products-images/p8.jpg" alt="Retis lapen casen"></a>
                  <div class="new-label new-top-left">New</div>
                  <div class="item-box-hover">
                    <div class="box-inner">
                      <div class="add_cart">
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="index.php?act=chitietsp" title="Retis lapen casen"
                    class="product-image"><img src="products-images/p6.jpg" alt="Retis lapen casen"></a>
                  <div class="new-label new-top-left">New</div>
                  <div class="item-box-hover">
                    <div class="box-inner">
                      <div class="add_cart">
